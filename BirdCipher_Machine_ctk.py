...
def translator():
	...
	if Spanish_mode == True:
		...
		login_label.configure(text = 'Inicia sesión en BirdCipher Machine!!', font = ("Times New Roman", 23))
		...
		notebk._segmented_button._buttons_dict['Human Firewall'].configure(text='Firewall Humano')
...
username_entry.configure(width = 260, text_color = '#e8b4e5', fg_color = 'black')
